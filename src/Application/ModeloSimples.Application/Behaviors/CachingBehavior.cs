...
public class CachingBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
{
    ...
    public async Task<TResponse> Handle(TRequest request, RequestHandlerDelegate<TResponse> next, CancellationToken cancellationToken)
    {
        ...
        var comandoDeCaching = _config.ComandosCaching.FirstOrDefault(c => c.Commando.Equals(requestType, StringComparison.OrdinalIgnoreCase));
    ...
    private async Task CacheResponseAsync<T>(string key, T response, ComandosCaching config)
    {
